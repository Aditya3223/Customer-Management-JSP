...
public class UpdateRecordForm 
{
	...
	private void dbConnection()
	{
		try
		{
			...
			query="update product set name=?,price=?,quantity=? where pid=?";
			ps1=cn.prepareStatement(query);
	...
	class UpdateListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e) 
		{
			try
			{
				...
				ps1.executeUpdate();
				JOptionPane.showMessageDialog(fr,"Record has been updated successfully");
				pa.setVisible(false);
			}
			catch(Exception ex)
			{
